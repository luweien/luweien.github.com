...
alert(1)
    ...
    $('.entry a').each(function(index, element) {
        ...
        if (href) {
            if (href.indexOf('#') == 0) {} else if (href.indexOf('/') == 0 || href.toLowerCase().indexOf('beiyuu.com') > -1) {} else if ($(element).has('img').length) {} else {
    ...
    (function() {
        ...
        function genIndex() {
            ...
            $('#menuIndex').append($(tmpl)).delegate('a', 'click',
            function(e) {
                e.preventDefault();
        ...
        if ($('.entry h2').length > 2 && !isMobile.any() && !ie6) {
            ...
            $(window).load(function() {
                ...
                $(window).resize(function() {
                    ...
                    $(window).trigger('scroll') $('#menuIndex').css('max-height', $(window).height() - 80);
                });
            })
    ...
    $.getScript('/js/prettify/prettify.js',
    function() {
        prettyPrint();
    });
